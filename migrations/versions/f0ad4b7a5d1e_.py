...
Revision ID: f0ad4b7a5d1e
Revises: 3c2f8b2eb0f7
Create Date: 2023-09-20 00:05:50.151821
...
revision = 'f0ad4b7a5d1e'
down_revision = '3c2f8b2eb0f7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('saving_throws', sa.PickleType(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
